class LikeToggleUseCase {
  ...
  async execute(useCasePayload) {
    ...
    const like = await this.likeRepository
      .getLike(useCasePayload.userId, useCasePayload.commentId);

    if (!like) {
      await this.likeRepository
        .addLike(useCasePayload.userId, useCasePayload.commentId);
    } else {
      await this.likeRepository
        .removeLike(useCasePayload.userId, useCasePayload.commentId);
    }
  }
}
