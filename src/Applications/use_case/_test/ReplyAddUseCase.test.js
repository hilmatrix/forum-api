...
describe('ReplyAddUseCase', () => {
  it('should orchestrating the add reply action correctly', async () => {
    ...
    mockReplyRepository.addReply = jest.fn().mockImplementation(
      () => Promise.resolve('reply-12345'),
    );

    const addReplyUseCase = new ReplyAddUseCase({
    ...
    expect(mockReplyRepository.addReply)
      .toBeCalledWith(useCasePayload.userId, useCasePayload.commentId, useCasePayload.content);
